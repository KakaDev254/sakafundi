    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('provider', 'Service Provider'), ('both', 'Both')], default='customer', max_length=10)),
                ...
                ('profile_image', models.ImageField(blank=True, default='profiles/default.jpg', null=True, upload_to='profiles/%Y/%m/')),
                ...
                ('id_photo', models.ImageField(blank=True, null=True, upload_to='verification/%Y/%m/')),
